...
\begin{figure}
	...
	\caption{The frequency weighted goodness of fit calculations. The adjusted $R^2$ values represent goodness of fit versus degrees of freedom.} \label{G_of_fit_1}
\end{figure}
