...
\subsection{Parameterizing a Multi-Function Fit or Parametrerizing the red noise transition}
...
two parameters that are being estimated from the fitting. The justification of fitting a folded normal distribution is that it assimilates the combined memory and diffusion induced by the CFA system.
